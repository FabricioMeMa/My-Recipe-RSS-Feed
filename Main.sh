...
ebook-convert ~/Documents/News/Script/Git/Minhas\ Notícias.recipe ~/Documents/News/Minhas\ Notícias-$HOJE.azw3 --output-profile kindle
...
swaks --to $EK -s smtp.gmail.com:587 -tls -au $EM -ap $PS  --header "Noticias" --attach  ~/Documents/News/Minhas\ Notícias-$HOJE.azw3
